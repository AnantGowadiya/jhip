...
```
$ docker image tag ui anantgowadiya/ui
$ docker push anantgowadiya/ui
$ docker image tag organization anantgowadiya/organization
$ docker push anantgowadiya/organization
$ docker image tag leave anantgowadiya/leave
$ docker push anantgowadiya/leave
$ docker image tag meeting anantgowadiya/meeting
$ docker push anantgowadiya/meeting
$ docker image tag notification anantgowadiya/notification
$ docker push anantgowadiya/notification
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n marvel
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n marvel
```
